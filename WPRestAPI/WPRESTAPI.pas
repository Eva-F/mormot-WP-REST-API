...
//      begin
//        Result.VType := vtPWideChar;
//        u := UnicodeString(Item.vUnicodeString);
//        Result.VString :=pointer(u);
//      end;
    vtAnsiString:
      begin
...
begin
  ...
  if Result = '' then
    Result := '0.2.1';        //latest test version
end;
...
procedure TWPRESTAPI.FinalizeVarRec(var Item: TVarRec);
begin
  case Item.VType of
...
{$REGION 'TWPRESTAPI1_0_3LEGS'}
  ...
  begin
    Result := False;
    lStep := 'OAUTH';
    if OauthPluginVersion = '0.2.1' then
      lStep := 'ACCESS';
